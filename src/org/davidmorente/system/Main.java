...
import org.davidmorente.controllers.MenuProveedorControllers;
...
public class Main extends Application {
    ...
    public void menuProveedoresView(){
        try{
            MenuProveedorControllers menuProveedoresView = (MenuProveedorControllers)cambiarEscena("MenuProveedores.fxml", 910, 512);
